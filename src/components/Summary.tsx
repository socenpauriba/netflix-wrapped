...
export const Summary: React.FC<SummaryProps> = ({ summary, rawData }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 bg-gradient-to-r from-[#E50914] to-[#831010] 
                       text-transparent bg-clip-text">
          El teu Netflix wrapped
        </h2>
        
        <div className="grid gap-8">
          <StatCard icon={PlayCircle} title="Continguts visualitzats">
            <p className="text-4xl md:text-5xl font-bold text-[#E50914]">
              {summary.totalShows}
            </p>
          </StatCard>

          <StatCard icon={Calendar} title="Top 5 sèries">
            <TopList 
          ...
          <StatCard icon={PlayCircle} title="Maratons">
